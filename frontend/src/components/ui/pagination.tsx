...
function PaginationPrevious({ className, label = 'Previous', ...props }: React.ComponentProps<typeof PaginationLink> & { label?: string }) {
  return (
...
function PaginationNext({ className, label = 'Next', ...props }: React.ComponentProps<typeof PaginationLink> & { label?: string }) {
  return (
