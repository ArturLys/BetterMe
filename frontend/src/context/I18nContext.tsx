...
const translations = {
  uk: {
    ...
    // Dashboard — drones
    'dash.drones': 'Керування дронами',
    'dash.drones.desc': 'Перегляд статусів та історії логів',
    'dash.drones.status.FREE': 'Вільний',
    'dash.drones.status.OCCUPIED': 'Зайнятий',
    'dash.drones.log.status.COMPLETED': 'Завершено',
    'dash.drones.log.status.IN_PROGRESS': 'В процесі',
    'dash.drones.status.RETURNING': 'Повертається',
    'dash.drones.facilitate': 'Додати дрони',
    'dash.drones.facilitate.success': 'Дрони успішно додані!',
    'dash.drones.facilitate.loading': 'Додаємо...',
    'dash.drones.logs.empty': 'Логи відсутні.',
    'dash.drones.log.order': 'Замовлення',
    'dash.drones.log.lat': 'Широта',
    'dash.drones.log.lng': 'Довгота',
    'dash.drones.log.start': 'Початок',
    'dash.drones.log.end': 'Кінець',
    'dash.drones.log.status.FINISHED': 'Завершено',
  ...
  en: {
    ...
    'dash.drones': 'Manage Drones',
    'dash.drones.desc': 'View drone statuses and logs',
    'dash.drones.status.FREE': 'Free',
    'dash.drones.status.OCCUPIED': 'Occupied',
    'dash.drones.log.status.COMPLETED': 'Completed',
    'dash.drones.log.status.IN_PROGRESS': 'In Progress',
    'dash.drones.status.RETURNING': 'Returning',
    'dash.drones.facilitate': 'Facilitate Drones',
    'dash.drones.facilitate.success': 'Drones facilitated!',
    'dash.drones.facilitate.loading': 'Facilitating...',
    'dash.drones.logs.empty': 'No logs found.',
    'dash.drones.log.order': 'Order',
    'dash.drones.log.lat': 'Lat',
    'dash.drones.log.lng': 'Lng',
    'dash.drones.log.start': 'Start',
    'dash.drones.log.end': 'End',
    'dash.drones.log.status.FINISHED': 'Finished',
